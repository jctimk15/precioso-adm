...
export interface ApiProdutoProduto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    codigo: Schema.Attribute.UID<'title'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    variacoes: Schema.Attribute.Component<'produtos.variacao', true>;
  };
}

export interface ApiProdutosDestaqueProdutosDestaque
  extends Struct.CollectionTypeSchema {
  collectionName: 'produtos_destaques';
  info: {
    displayName: 'ProdutosDestaque';
    pluralName: 'produtos-destaques';
    singularName: 'produtos-destaque';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    codigoDestaque: Schema.Attribute.UID<'nome'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::produtos-destaque.produtos-destaque'
    > &
      Schema.Attribute.Private;
    nome: Schema.Attribute.String;
    price: Schema.Attribute.Decimal;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::produtos-destaque.produtos-destaque': ApiProdutosDestaqueProdutosDestaque;
